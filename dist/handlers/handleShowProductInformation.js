...
function handleShowProductInformation(chatId, data, username, bot) {
    ...
    if ((productInformation === null || productInformation === void 0 ? void 0 : productInformation.prices.length) > 0) {
        ...
        if (productInformation === null || productInformation === void 0 ? void 0 : productInformation.imagePath) {
            try {
                if (productInformation === null || productInformation === void 0 ? void 0 : productInformation.imagePath.startsWith("https://drive.google.com/")) {
                    ...
                    imagePath = productInformation === null || productInformation === void 0 ? void 0 : productInformation.imagePath;
                }
            }
            catch (_a) {
